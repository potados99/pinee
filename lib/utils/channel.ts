...
export function isNonPublicChannel(
  channel: TextChannel | DMChannel | NewsChannel /* Channels with message */
) {
  // @ts-ignore
  const channelPermissionsOverwrites: Map<string, PermissionOverwrites> =
